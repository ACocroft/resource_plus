...
//All the code below comes directly from Firebase documentation. We move our config values into a .env file
//in order to keep them out of our source control history.
...
//We export auth below so we can use this object in our React Context (AuthContext.js)
//the line below is the only in this file we did not get directly from Firebase
export { auth }